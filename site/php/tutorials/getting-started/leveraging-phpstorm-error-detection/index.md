...
{% video "../e3-deprecations.webm", width=1366, height=768 %}
...
{% video "../e3-warnings.webm", width=1366, height=768 %}
...
{% video "../e3-scan-project.webm", width=1366, height=768 %}
...
{% video "../e3-inspections-720.webm", width=1366, height=768 %}
