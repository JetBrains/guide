...
Brian Okken leads the pack with a [Python Testing with pytest](https://pragprog.com/book/bopytest/python-testing-with-pytest) book and a Python test podcast on all things testing. In addition, Brian Okken has a [book](https://pythontest.com/pytest-book/) and a (paid) [complete pytest course](https://pythontest.teachable.com/p/complete-pytest-course).
