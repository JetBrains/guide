...
export class ExplorePage {
  ...
  render(this: LayoutContext, data: ExplorePageProps): JSX.Element {
    const latestContent = this.getResources({ resourceType: "tip" })
      .concat(this.getResources({ resourceType: "tutorial" }))
          ...
          <div class="container">
            <div class="navbar-brand">
              <div class="navbar-item is-size-5 has-text-weight-semibold pl-0">
                <a href="/explore/" class="is-hidden-touch">Explore</a>
                <a href="/explore/" class="is-hidden-desktop ml-5">Explore</a>
              </div>
            </div>
          </div>
        </nav>
              ...
              <div class="column">
                <div class="columns is-multiline">
                  <div class="column is-12 is-5-desktop mb-5 mr-auto">
                    <h2 class="title mb-6 is-size-1 is-size-3-mobile has-text-weight-bold">Explore our channels</h2>
                    <p class="subtitle has-text-grey">Looking to learn something new, or refresh your existing skills?</p>

                    <div class="buttons mt-6">
                      <a class="button is-rounded is-primary is-outlined" href="#">Browse...</a>
                    </div>
                  </div>
                  <div class="column is-12 is-6-desktop">
                    <div class="columns is-multiline is-mobile">
                      <div class="column mb-1 is-6 py-5">
                        ...
                        <a href="/dotnet/" class="is-size-5 has-text-weight-bold title">.NET</a>
                      </div>
                      <div class="column mb-1 is-6 py-5">
                        <a href="/go/">
                          <figure class="image is-48x48 mb-1">
                        ...
                        <a href="/go/" class="is-size-5 has-text-weight-bold title">GoLand</a>
                      </div>
                      <div class="column mb-1 is-6 py-5">
                        <a href="/idea/">
                          <figure class="image is-48x48 mb-1">
                            <Logo product="intellij-idea" width={48} height={48} />
                          </figure>
                        </a>
                        <a href="/idea/" class="is-size-5 has-text-weight-bold title">IntelliJ IDEA</a>
                      </div>
                      <div class="column mb-1 is-6 py-5">
                        <a href="/pycharm/">
                          <figure class="image is-48x48 mb-1">
                        ...
                        <a href="/pycharm/" class="is-size-5 has-text-weight-bold title">PyCharm</a>
                      </div>
                      <div class="column mb-1 is-6 py-5">
                        <a href="/webstorm/">
                          <figure class="image is-48x48 mb-1">
                        ...
                        <a href="/webstorm/" class="is-size-5 has-text-weight-bold title">WebStorm</a>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="column is-12">
                    <div class="columns is-vcentered is-mobile">
                      <div class="column is-8">
                        <h1 class="mt-2 mb-4 is-size-1 has-text-weight-bold">Latest</h1>
                      </div>
                      <div class="column has-text-right">
                        <a class="button is-rounded is-outlined" href="#">All...</a>
                      </div>
                    </div>
                    <div class="columns is-multiline">
