...
Let me start creating the "organizations" directory. But before that let me delete the "hello_world".
...
"Codeuri" indicates the location of my code directory, and the term "Handler" represents the amalgamation of _folder_name.file_name.function_name_.
...
I will click on _Run_ and then _Edit Configurations_.
...
Now, let’s test the functionality. I will click on _Run_ and then _Edit Configurations_.
...
Click on _Run_ and then _Edit Configurations_.
I will pass the "id" of David Jones in _pathParameters_.
