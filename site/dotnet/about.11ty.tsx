                            ...
                            <div className="column is-three-quarters-desktop">
                                <div className="bd-content content">
                                    <div className="content">
                                        ...
                                        <p>JetBrains tools included in the <a href="https://www.jetbrains.com/dotnet/">dotUltimate
                                            pack</a> are powerful developer productivity tools. What is the best way to
                                            learn how to harness that power?</p>
                                        <p>You can find useful information on our Twitter accounts, <a
                                            href="https://twitter.com/ReSharper">@ReSharper</a> and
                                            <a href="https://twitter.com/JetBrainsRider">@JetBrainsRider</a>, or our <a
                                                href="https://blog.jetbrains.com/dotnet/">product blog</a>.

                                            Plus, the <a
                                                href="https://www.jetbrains.com/resharper/documentation/documentation.html">documentation</a> is
                                            always there to help. However, wouldn't it be better if you had everything
                                            you needed to learn in one place?</p>
                                        <p>We have created the .NET Tools Guide, a collection of bite-sized visual
                                        ...
                                        <p>The .NET Tools Guide is also an open project, with <a
