...
<kbd>⌘+</kbd> (macOS) / <kbd>Ctrl+Plus</kbd> (Windows/Linux)                    - Expand All
<kbd>⌘-</kbd> (macOS) / <kbd>Ctrl+Minus</kbd> (Windows/Linux)                   - Collapse All
...
<kbd>⌘F8</kbd> (macOS) / <kbd>Ctrl+F8</kbd> (Windows/Linux)                     - Place Breakpoint
...
<kbd>⌃D</kbd> (macOS) / <kbd>Shift+F9</kbd> (Windows/Linux)                     - Debug Project
